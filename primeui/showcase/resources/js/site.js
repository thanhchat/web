...
Showcase = {
    ...
    bindEvents: function() {
        ...
        $("#GlobalThemeSwitcher > a").on("click", function(e) {
            ...
            newThemeURL =  '../primeui/showcase/' + 'themes/' + theme + '/theme.css';
            themeLink.attr('href', newThemeURL);
			Showcase.changeTheme(theme);
            e.preventDefault();
        });
    ...
    openPageHash: function(hash) {
        if(hash && hash.length > 1) {
            ...
            var menuitem = this.menu.find('a.SubMenuLink[href="'+ plainHash + '.phtml"]');
            if(menuitem.length) {
    ...
    openPage: function(url) {
        ...
        $.get(url, function(content) {
            $('#ContentPagePortal').html(content);
        });
    },
    ...
    demo: {
        ...
        loadAllCars: function(callback) {
            $.ajax({
                type: "GET",
                url: '../primeui/showcase/resources/data/cars-large.json',
                dataType: "json",
                context: this,
        ...
        remoteTreeNodes: function(ui, response) {
            $.ajax({
                type: "GET",
                url: '../primeui/showcase/resources/data/nodes.json',
                dataType: "json",
                context: this,
